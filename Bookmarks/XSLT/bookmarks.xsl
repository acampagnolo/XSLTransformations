...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="filenamePath"
        select="concat('../../Transformations/Bookmarks/SVGoutput/', $fileref[1], '/', $fileref[1], '_', 'Bookmarks')"/>
    ...
    <xsl:template name="main" match="/">
        <xsl:choose>
            <xsl:when test="book/markers/yes/marker/bookmark">
    ...
    <xsl:template name="endbandDiagrams">
        ...
        <xsl:choose>
            <xsl:when test="xs:integer($primaryCores) gt 1">
                ...
                <!-- NB: how to draw this? -->
                <!-- TO DO -->
                <!-- For the moment draw just one as below just to have something. Come back to this after having done the endband transformation -->
                <use xmlns="http://www.w3.org/2000/svg">
                    <xsl:attribute name="xlink:href">
        ...
        <xsl:choose>
            <xsl:when test="xs:integer($crowningCores) gt 1">
                ...
                <use xmlns="http://www.w3.org/2000/svg">
                    ...
                    <xsl:attribute name="y">
                        <xsl:value-of
                            select="if (./compound/primaryType/span2) then $Oy + 39 else $Oy + 40"/>
                    </xsl:attribute>
                </use>
                <use xmlns="http://www.w3.org/2000/svg">
                    <xsl:attribute name="xlink:href">
            ...
            <xsl:when test="xs:integer($crowningCores) eq 1">
                <use xmlns="http://www.w3.org/2000/svg">
                    <xsl:attribute name="xlink:href">
                        <xsl:text>#crowningCore</xsl:text>
                    </xsl:attribute>
                    <xsl:attribute name="x">
                        <xsl:value-of select="$Ox + 48"/>
                    </xsl:attribute>
                ...
                <use xmlns="http://www.w3.org/2000/svg">
                    <xsl:attribute name="xlink:href">
                        <xsl:text>#crowningCore_front</xsl:text>
                    </xsl:attribute>
                    <xsl:attribute name="x">
                        <xsl:value-of select="$Ox + 100"/>
                    </xsl:attribute>
        ...
        <use xmlns="http://www.w3.org/2000/svg">
            ...
            <xsl:attribute name="x">
                <xsl:value-of select="$Ox + 77.5"/>
            </xsl:attribute>
            <xsl:attribute name="y">
                <xsl:value-of select="$Oy + 30"/>
            </xsl:attribute>
        </use>
        <use xmlns="http://www.w3.org/2000/svg">
            <xsl:attribute name="xlink:href">
        ...
        <text xmlns="http://www.w3.org/2000/svg" class="noteText2">
            <xsl:attribute name="x">
                <xsl:value-of select="$Ox + 110"/>
            </xsl:attribute>
            <xsl:attribute name="y">
                <xsl:value-of select="$Oy + 35"/>
            </xsl:attribute>
            <xsl:text>Front view</xsl:text>
        </text>
        <text xmlns="http://www.w3.org/2000/svg" class="noteText2">
            <xsl:attribute name="x">
                <xsl:value-of select="$Ox + 201"/>
            </xsl:attribute>
            <xsl:attribute name="y">
                <xsl:value-of select="$Oy + 35"/>
            </xsl:attribute>
            <xsl:text>Spine view</xsl:text>
        </text>
        <text xmlns="http://www.w3.org/2000/svg" class="noteText2">
            <xsl:attribute name="x">
                <xsl:value-of select="$Ox + 110"/>
            ...
            <xsl:attribute name="y">
                <xsl:value-of select="$Oy + 135"/>
            </xsl:attribute>
            <xsl:text>Above view</xsl:text>
        </text>
    </xsl:template>
        ...
        <g xmlns="http://www.w3.org/2000/svg">
            ...
            <xsl:choose>
                <xsl:when test="./compound/primaryType/multipleSpan">
                    ...
                    <use xmlns="http://www.w3.org/2000/svg">
                        <xsl:attribute name="xlink:href">
                            <xsl:text>#multipleSpan_back</xsl:text>
                        </xsl:attribute>
                        <xsl:attribute name="x">
                            <xsl:value-of select="$x_front + 90"/>
                        </xsl:attribute>
                        <xsl:attribute name="y">
                            <xsl:value-of select="$y_front"/>
                        </xsl:attribute>
                ...
                <xsl:choose>
                    <xsl:when test="./compound/primaryType/span2">
                        <xsl:attribute name="clip-path">
                            <xsl:text>url(#span2_clip)</xsl:text>
                        </xsl:attribute>
                    </xsl:when>
                </xsl:choose>
                <xsl:attribute name="x">
            ...
            <xsl:choose>
                <xsl:when test="./compound/primaryType/multipleSpan">
                    ...
                    <use xmlns="http://www.w3.org/2000/svg">
                        <xsl:attribute name="xlink:href">
                            <xsl:text>#multipleSpan_back_above</xsl:text>
                        </xsl:attribute>
                        <xsl:attribute name="x">
                            <xsl:value-of select="$x_above"/>
                        </xsl:attribute>
                        <xsl:attribute name="y">
                            <xsl:value-of select="$y_above - 15"/>
                        </xsl:attribute>
                    </use>
                </xsl:when>
            </xsl:choose>
        ...
        <g xmlns="http://www.w3.org/2000/svg">
            ...
            <use xmlns="http://www.w3.org/2000/svg">
                <xsl:attribute name="xlink:href">
                    <xsl:choose>
                        ...
                        <xsl:when
                            test="./compound/primaryAttachment/type/frayed and ./compound/primaryType/span2">
                            <xsl:value-of
                                select="concat('#', ./compound/primaryAttachment/type/node()[2]/name(), '2')"
                            />
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of
                                select="concat('#', ./compound/primaryAttachment/type/node()[2]/name())"
                            />
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:attribute>
            ...
            <use xmlns="http://www.w3.org/2000/svg">
                ...
                <xsl:attribute name="x">
                    <xsl:choose>
                        ...
                        <xsl:when
                            test="./compound/primaryType[closedLoop | twistedSpan | twistedClosedLoop | NC | NK]">
                            <xsl:value-of
                                select="if (./compound/primaryAttachment/type/frayed) then $x_back else $x_back - 0.5"
                            />
                        </xsl:when>
                    </xsl:choose>
                </xsl:attribute>
            ...
            <xsl:variable name="x_back">
                <xsl:choose>
                    ...
                    <xsl:when
                        test="./compound/primaryType[closedLoop | twistedSpan | twistedClosedLoop]">
            ...
            <xsl:choose>
                ...
                <xsl:when test="./compound/primaryAttachment/type">
                    <use xmlns="http://www.w3.org/2000/svg">
                        <xsl:attribute name="xlink:href">
                            <xsl:choose>
                                <xsl:when test="./compound/primaryAttachment/type[NC | NK | other]">
    ...
    <xsl:template name="secondaryTypeXYvalues">
        ...
        <xsl:variable name="x">
            <xsl:choose>
                <xsl:when
                    test="./compound/primaryType[span1 | multipleSpan | closedLoop | NC | NK | other]">
                ...
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
                    <xsl:value-of
                        select="if (./compound/secondaryType[knottedDoubleLength | knottedSingleLength]) then $Ox + 64 else $Ox + 63"
                    />
                </xsl:when>
            </xsl:choose>
        </xsl:variable>
        <xsl:variable name="x_front">
            <xsl:choose>
                <xsl:when
                    test="./compound/primaryType[span1 | span2 | multipleSpan | closedLoop | NC | NK | other]">
                    <xsl:value-of select="$Ox + 140"/>
                </xsl:when>
                <xsl:when test="./compound/primaryType/twistedSpan">
                ...
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
                    <xsl:value-of
                        select="if (./compound/secondaryType[knottedDoubleLength | knottedSingleLength]) then $Ox + 140 else $Ox + 138"
                    />
                </xsl:when>
                <!--<!-\- Alternative positioning -\->
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
        ...
        <xsl:variable name="x_above">
            <xsl:choose>
                ...
                <xsl:when test="./compound/primaryType/twistedSpan">
                    <xsl:value-of
                        select="if (./compound/secondaryType[knottedDoubleLength | knottedSingleLength]) then $Ox + 136 else $Ox + 137.5"
                    />
                </xsl:when>
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
                    <xsl:value-of
        ...
        <xsl:variable name="y">
            <xsl:choose>
                ...
                <xsl:when test="./compound/primaryType/twistedSpan">
                    <xsl:value-of
                        select="if (./compound/secondaryType[knottedDoubleLength | knottedSingleLength | hitchedDoubleLength]) then $Oy + 56 else $Oy + 57.5"
                    />
                </xsl:when>
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
                    <xsl:value-of
                        select="if (./compound/secondaryType[knottedDoubleLength | knottedSingleLength]) then $Oy + 52.5 else $Oy + 55.5"
                    />
                </xsl:when>
                <!--<!-\- Alternative positioning -\->
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
        ...
        <xsl:variable name="y_front">
            <xsl:choose>
                ...
                <xsl:when test="./compound/primaryType/twistedSpan">
                    <xsl:value-of select="$Oy + 63"/>
                </xsl:when>
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
                    <xsl:value-of
                        select="if (./compound/secondaryType[knottedDoubleLength | knottedSingleLength]) then $Oy + 68 else $Oy + 70.5"
                    />
                </xsl:when>
                <!--<!-\- Alternative positioning -\->
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
        ...
        <xsl:variable name="y_above">
            <xsl:choose>
                <xsl:when test="./compound/primaryType[span1 | multipleSpan | other]">
                    <xsl:value-of select="$Oy + 161"/>
                </xsl:when>
                <xsl:when test="./compound/primaryType/span2">
                    <xsl:value-of select="$Oy + 154"/>
                </xsl:when>
                <xsl:when test="./compound/primaryType[closedLoop | NC | NK]">
                    <xsl:value-of select="$Oy + 167"/>
                </xsl:when>
                <xsl:when test="./compound/primaryType/twistedSpan">
                    <xsl:value-of select="$Oy + 163"/>
                </xsl:when>
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
                    <xsl:value-of
                        select="if (./compound/secondaryType[knottedDoubleLength | knottedSingleLength]) then $Oy + 161.5 else $Oy + 163.5"
                    />
                </xsl:when>
                <!--<!-\- Alternative positioning -\->
                <xsl:when test="./compound/primaryType/twistedClosedLoop">
            ...
            <use xmlns="http://www.w3.org/2000/svg">
                <xsl:attribute name="xlink:href">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:value-of
                                select="concat('#', ./compound/secondaryType/node()[2]/name())"/>
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:attribute>
                <xsl:attribute name="x">
        ...
        <g xmlns="http://www.w3.org/2000/svg">
            ...
            <text xmlns="http://www.w3.org/2000/svg" x="{$Ox + 35}" y="{$Oy + 40}">
                <xsl:choose>
                    ...
                    <xsl:when test="./compound">
                        <tspan xmlns="http://www.w3.org/2000/svg" x="{$Ox + 35}">
                            <xsl:text>Compound bookmark</xsl:text>
                        </tspan>
                        <tspan xmlns="http://www.w3.org/2000/svg" dy="6.5" x="{$Ox + 35}">
                            <xsl:text>Primary type: </xsl:text>
                            <tspan xmlns="http://www.w3.org/2000/svg" x="{$Ox + 85}">
                                <xsl:value-of
                                    select="if (./compound/primaryType/other) then concat(./compound/primaryType/node()[2]/name(), ': ', ./compound/primaryType/other/text()) else ./compound/primaryType/node()[2]/name()"
                                />
                            </tspan>
